...
const fieldStyles = tv({
  slots: {
    description: 'text-muted-fg text-base/6 group-disabled:opacity-50 sm:text-sm/6',
    label: 'text-fg text-base/6 select-none group-disabled:opacity-50 sm:text-sm/6',
    fieldError:
      'text-danger text-base/6 group-disabled:opacity-50 sm:text-sm/6 forced-colors:text-[Mark]',
  },
})
  ...
  return (
    <Group
      ...
      className={composeTailwindRenderProps(className, [
        ...
        'group inset-ring-input relative flex items-center overflow-hidden rounded-lg shadow-xs inset-ring transition duration-200 ease-out',
