...
function Toast({ state, ...props }: ToastProps) {
  ...
  return (
    <div
      {...toastProps}
      ref={ref}
      className="ring-opacity-5 pointer-events-auto relative w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black"
    >
      <div className="p-4">
        <div className="flex items-start">
          <div className="flex-shrink-0">
            <CircleCheckBigIcon className="h-6 w-6 text-green-400" />
          </div>
