...
const dropdownItemStyles = tv({
  base: [
    ...
    'data-danger:**:data-[slot=icon]:text-danger/60 **:data-[slot=icon]:text-muted-fg focus:data-danger:**:data-[slot=icon]:text-danger *:data-[slot=icon]:mr-(--mr-icon) **:data-[slot=icon]:size-5 **:data-[slot=icon]:shrink-0 sm:**:data-[slot=icon]:size-4',
...
const dropdownSectionStyles = tv({
  slots: {
    ...
    header:
      'text-muted-fg col-span-full px-3.5 py-2 text-sm/6 font-medium sm:px-3 sm:py-1.5 sm:text-xs/6',
  },
})
