  ...
  return (
    <PopoverPrimitive
      ...
      className={composeTailwindRenderProps(className, [
        'group/popover bg-overlay text-overlay-fg max-w-xs min-w-(--trigger-width) rounded-xl border bg-clip-padding shadow-xs outline-hidden transition-transform [--gutter:--spacing(6)] sm:text-sm dark:backdrop-saturate-200 **:[[role=dialog]]:[--gutter:--spacing(4)]',
